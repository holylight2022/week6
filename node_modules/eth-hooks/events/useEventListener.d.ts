 ...
 */
export declare const useEventListener: (contracts: Record<string, Contract>, contractName: string, eventName: string, provider: TEthersProvider, startBlock: number) => Event[];
